...
int main(){
    ...
    arr.push_back("output_35_5.txt");
    arr.push_back("output_70_7.txt");
    arr.push_back("output_111_9.txt");
	...
	string file_name4 = "";
	string file_name5 = "";
	file_name1 = file_name1 + "fine tuning performance indicator 1" + ".txt";
	file_name2 = file_name2 + "fine tuning performance indicator 2" + ".txt";
	file_name3 = file_name3 + "fine tuning performance indicator 3" + ".txt";
	file_name4 = file_name4 + "fine tuning performance indicator 4" + ".txt";
	file_name5 = file_name5 + "fine tuning performance indicator 5" + ".txt";
