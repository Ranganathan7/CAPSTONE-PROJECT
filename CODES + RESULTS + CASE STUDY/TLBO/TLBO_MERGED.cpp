...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
        object1.r = 0.0 + ((double) rand() / (RAND_MAX/(0.5-0.0)));
   	    object1.tf = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object1.tp = 1.5 - object1.tf;
...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
       object2.r = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
   	    object2.tf = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object2.tp = 1.5 - object2.tf;
...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
       object3.tf = 0.0 + ((double) rand() / (RAND_MAX/(0.5-0.0)));
   	    object3.r = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object3.tp = 1.5 - object3.r;
...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
       object4.tf = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
   	    object4.r = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object4.tp = 1.5 - object4.r;
...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
       object5.tp = 0.0 + ((double) rand() / (RAND_MAX/(0.5-0.0)));
   	    object5.r = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object5.tf = 1.5 - object5.r;
...
{//TLBO
   ...
   for(int t=2;t<=T;t++){
       cout<<t<<" ";
       object6.tf = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
   	    object6.r = 0.5 + ((double) rand() / (RAND_MAX/(1-0.5)));
        object6.tp = 1.5 - object6.r;
